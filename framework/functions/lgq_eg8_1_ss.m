...
function [mpc] = lgq_eg8_1_ss()
	...
	mpc.bus = [
		...
		1	3	80	20	0	0	1	1.00	0	16.5	1	1.1	0.9;
		2	1	0	0	0	0	1	1.00	0	18.0	1	1.1	0.9;
		3	1	0	0	0	0	1	1.00	0	13.8	1	1.1	0.9;
		4	2	80	20	0	0	1	1.00	0	230.0	1	1.1	0.9;
	];

	% Generator(nodeId,Pg,Qg,Qmax,Qmin,Vg,mBase,status,Pmax,Pmin)
	mpc.gen = [

		4	20	0	300	-300	1.00	100	1	250	-10;
	];

	% Branches(from, to, r, x, b, rateA, rateB, rateC, ratio, angle, status, angmin, angmax)
	mpc.branch = [

		1	2	0	0.03	0	0	0	0	1	0	1	-180	180;
		2	3	0	0.06	0	0	0	0	0	0	1	-180	180;
		% 2	3	0	0.06	0	0	0	0	0	0	1	-180	180;
		3	4	0	0.03	0	0	0	0	1	0	1	-180	180;
	];
end
